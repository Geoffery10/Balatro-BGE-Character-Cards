--- STEAMODDED HEADER
--- MOD_NAME: BGE Characters
--- MOD_ID: bge_deckall
--- PREFIX: bge
--- MOD_AUTHOR: [Geoffery10]
--- MOD_DESCRIPTION: BGE Character Card Skins
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: 444DC3

local atlas_key = 'bge_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'bge_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'bge_hc.png' -- Filename for the high-contrast version of the texture, if existing
